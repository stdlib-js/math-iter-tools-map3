...
```javascript
iterMap3 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools-map3@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools-map3@v0.2.0-umd/browser.js"></script>
```
